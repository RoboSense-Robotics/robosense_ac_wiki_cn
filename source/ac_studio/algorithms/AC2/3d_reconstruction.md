...
本示例是一个从 AC2 的原始数据到完成 Gaussian Splatting 重建进而导出 Mesh 的完整流程。

下面的视频展示了仅依赖 AC2 的传感器数据进行重建和渲染之后的效果：
...
🚀 项目地址：[3D Reconstruction](https://github.com/RoboSense-Robotics/3D-Reconstruction)
